 ...
 <head>
   ...
   <title>Rihana Park Contact</title>
 ...
 <body style="background-image: url(./image//lease.jpg); background-size: cover;">
   ...
   <form method="POST">
     <div class="container">
       ...
       <div class="box">
         <h3 style="color: black;">تقدم بطلب الإيجار</h3>
         <div class="name">
         ...
         <div class='ServiceRequiredByRahinaPark'>
           ...
           <input type="text" placeholder="الخدمات المطلوبة من إدارة المشروع" name="ServiceRequiredByRahinaPark" required autocomplete="off">
         </div>
