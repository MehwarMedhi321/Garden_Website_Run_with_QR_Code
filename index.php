  ...
  <div class="container2">
    ...
    <div class="otherCards" data-aos="zoom-in-right">
      ...
      <div class="contact-details">
        <div class="inputBox">
          <span><i class="fas fa-phone" id="firstNumber"></i></span>
          <input type="text" id="FirstNumberIcon" disabled value="+987 765648576">
          <span class="material-icons" id="copyIcon">content_copy</span>
          <br>
          <br>
          <span><i class="fas fa-phone" id="firstNumber"></i></span>
          <input type="text" id="SecondNumberIcon" disabled value="+987 765648576">
          <span class="material-icons" id="copyIconTow">content_copy</span>
        </div>
      </div>
    </div>
    <div class="otherCards" data-aos="zoom-in-right">
